...
class RecipeView extends View {
  ...
  loadRecipe(handler) {
    ...
    //insertAdjacentHTML("afterbegin", handler);
  }

  generateHTML(data) {
    return `
                      <figure class="recipe__fig">
                        <img src=${data.imageUrl} alt="Tomato" class="recipe__img" />
                      ...
                      <div class="recipe__details">
                        ...
                        <div class="recipe__info">
                          ...
                          <div class="recipe__info-buttons">
                            <button data-goto="${+data.servings - 1}" class="btn--tiny btn--decrease-servings">
                              <svg>
                                <use href="${icons}#icon-minus-circle"></use>
                              </svg>
                            </button>
                            <button data-goto="${+data.servings + 1}" class="btn--tiny btn--increase-servings">
                              <svg>
                      ...
                      <div class="recipe__ingredients">
                        ...
                        ${data.ingredients.map((ing) => this.generateIngredientHtml(ing)).join("")}
                        </ul>
                      </div>
